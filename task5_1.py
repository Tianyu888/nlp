...
for idx, (label, text, offsets) in enumerate(test_dataloader):
    test_list.append([label, text, offsets])
...
for epoch in range(1, EPOCHS + 1):
    ...
    checkpoint = {'model_state_dict':model.state_dict(),
                  ...
                  'epoch':epoch}
    path_checkpoint = './checkpoints_4000/checkpoint_{}_epoch.pkl'.format(epoch)
    torch.save(checkpoint, path_checkpoint)

np.save('valid_accu_log.npy', valid_accu_log)
torch.save(test_list, './checkpoints_4000/test_list.pt')
torch.save(valid_list, './checkpoints_4000/valid_list.pt')
torch.save(train_list, './checkpoints_4000/train_list.pt')